...
Any laptop from the last ~6 years works. Best voices: **Edge on Windows** (Microsoft Natural voices, no install) or **Safari/Chrome on macOS** after installing a Premium voice (System Settings → Accessibility → Spoken Content). Headphones recommended if you enable always-on listening — otherwise the lecturer hears himself and interrupts his own sentence.
